    ...
    <div className='flex items-center justify-center gap-4 relative'>
        ...
        <AnimatePresence>
            {isMenu && (
                ...
                whileTap={{scale: 0.9}} className='text-primaryText text-lg hover:bg-[rgba(256,256,256, 0.05)] px-2 py-1 w-full rounded-md cursor-pointer hover:bg-[rgba(256,256,256,0.05)]'>Sign Out</motion.p>
            </motion.div>
            )}
        </AnimatePresence>
    </div>
